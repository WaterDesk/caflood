...
set(CAAPI_IMPL_NAME "Simple 1L Hexagonal Grid")

# The short name of the implementation. This is used for the package name.
set(CAAPI_IMPL_SHORTNAME  "S1LHG")
...
cpack_add_component(${CAAPI_IMPL_COMPONENT_NAME} DISPLAY_NAME "${CAAPI_IMPL_NAME} version ${CAAPI_IMPL_VERSION}"
  DESCRIPTION "Simple implementation of the CAAPI that uses a Hexagonal
  grid with one single level that run on a single CPU " 
  GROUP impls)
